...
\resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItem{Incorporated \textbf{MVVM} Architecture, Portal separation for both Farmer and Trader, used \textbf{Firebase} tools like \textbf{Auth}, \textbf{Firestore}, and \textbf{Storage}. \textbf{Multi-Language support} built with \textbf{Locale}}
 ...
 \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItem{Using \textbf{Hello Sign API}, built a \textbf{CRUD} App along with \textbf{Client-Data separation.} MVVM with \textbf{Retrofit} dependency, \textbf{Data class} for response parsing, and \textbf{QR generation} with \textbf{embedded URLs}}
...
\section{\textbf{Technical Skills}}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Developer Tools}{: Android-Studio, Azure, AWS, Postman, Google Cloud} \\
